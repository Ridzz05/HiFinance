    ...
    <header className="animate__animated animate__fadeInDown fixed top-0 w-full z-50 backdrop-blur-md bg-slate-950/70 border-b border-white/5">
      <div className="flex h-16 w-full max-w-7xl mx-auto items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl shadow-lg shadow-cyan-500/20 shrink-0">
          ...
          <div className="flex flex-col leading-none">
            <span className="text-sm font-bold text-white tracking-tight">HiFinance Bot</span>
            <span className="text-[10px] font-medium text-cyan-400">@hifinance_bot</span>
          </div>
        </div>
        {/* CTA */}
        <Link
          ...
          className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-linear-to-r from-cyan-400 to-blue-600 px-5 py-2 text-sm font-bold text-slate-900 shadow-lg shadow-cyan-500/20 transition-all duration-300 hover:scale-105 hover:shadow-cyan-400/40"
        >
          Buka Bot
...
function Hero() {
  return (
    <section className="relative min-h-screen w-full overflow-x-hidden pt-28 pb-20 flex items-center">
      {/* Aurora blobs */}
      <div className="pointer-events-none absolute -top-40 -left-40 h-[700px] w-[700px] rounded-full bg-cyan-500/10 blur-[160px]" />
      <div className="pointer-events-none absolute -bottom-40 -right-40 h-[600px] w-[600px] rounded-full bg-cyan-400/8 blur-[140px]" />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <AnimatedSection animation="animate__fadeInLeft" className="flex flex-col">
            {/* Live badge */}
            <div className="mb-8 inline-flex w-fit items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1.5 backdrop-blur-sm">
              <span className="relative flex h-2 w-2">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-cyan-400 opacity-75" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-cyan-500" />
              </span>
              <span className="text-xs font-semibold uppercase tracking-wider text-cyan-400">Live on Telegram</span>
            </div>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 rounded-2xl bg-linear-to-r from-cyan-400 to-blue-600 px-8 py-4 text-sm font-bold text-slate-900 shadow-xl shadow-cyan-500/25 transition-all hover:scale-105 hover:shadow-cyan-400/40 active:scale-95"
              >
              ...
              <Link href="/home#features" className="text-sm font-medium text-slate-400 hover:text-cyan-400 transition-colors underline-offset-4 hover:underline">
                Lihat Fitur →
              </Link>
            </div>
          ...
          >
            ...
            <div className="animate__float absolute -right-4 top-1/4 z-20 hidden sm:flex items-center gap-3 rounded-2xl border border-white/10 bg-slate-900/80 p-4 backdrop-blur-xl shadow-xl">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-cyan-400">Sangat Baik 🎉</p>
              </div>
            </div>
            ...
            <div className="animate__float relative w-full max-w-[340px]" style={{ animationDelay: "1s" }}>
              ...
              <div className="relative rounded-[3rem] bg-linear-to-b from-slate-200 to-slate-400 dark:from-slate-700 dark:to-slate-900 p-[3px] shadow-[0_0_80px_rgba(0,255,255,0.15)] border border-white/10">
                ...
                <div className="relative flex-1 flex col overflow-hidden rounded-[2.8rem] bg-charcoal shadow-inner aspect-9/19">
                  ...
                  <div className="absolute left-1/2 top-4 z-50 flex h-7 w-28 -translate-x-1/2 items-center justify-between rounded-full bg-black px-3 shadow-[0_1px_4px_rgba(255,255,255,0.1)] border border-white/5">
                    ...
                    <div className="h-3 w-3 rounded-full bg-cyan-400/20 shadow-[0_0_8px_#00FFFF]" />
                  </div>
              ...
              <div className="absolute bottom-[-20px] left-1/2 -translate-x-1/2 h-10 w-4/5 rounded-full bg-cyan-500/20 blur-2xl" />
            </div>
          </AnimatedSection>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <AnimatedSection className="text-center mb-20 max-w-2xl mx-auto">
          <h2 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
            Pencatatan Otomatis <span className="text-cyan-400">Tanpa Repot.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 overflow-hidden mt-12">
          {FEATURES.map((feat, i) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white/5 border border-white/10 transition-colors shadow-lg group-hover:bg-cyan-500/10 group-hover:border-cyan-500/30">
                  <feat.icon className="h-7 w-7 text-cyan-400 drop-shadow-[0_0_8px_rgba(0,255,255,0.4)]" />
                </div>
                {/* Text */}
                <h3 className="mb-3 text-2xl font-bold text-white tracking-tight">{feat.title}</h3>
    ...
    <section className="py-32 w-full bg-slate-950 relative z-10">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          <h2 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
            Pertanyaan yang Sering <span className="text-cyan-400">Diajukan</span>
          </h2>
        ...
        >
          <Accordion type="single" collapsible className="w-full flex flex-col gap-2">
            {FAQS.map((faq, i) => (
              ...
              >
                <AccordionTrigger className="text-left text-lg font-semibold text-white hover:no-underline hover:text-cyan-400 transition-colors py-5">
                  {faq.q}
                </AccordionTrigger>
...
function FinalCTA() {
  return (
    <section className="relative py-28 w-full bg-slate-950 overflow-hidden z-10">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-transparent to-cyan-900/20" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-[400px] bg-cyan-500/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <AnimatedSection animation="animate__zoomIn" className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-2xl bg-cyan-500 px-8 py-4 text-base font-bold text-slate-950 shadow-xl shadow-cyan-500/25 transition-all hover:scale-105 hover:bg-cyan-400 active:scale-95"
          >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-white">HiFinance</span>
          </div>
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans antialiased selection:bg-cyan-500/30">
      <Navbar />
      <main>
        <Hero />
        <Features />
